...
st.markdown("##### \n-The dataset used in this project is: https://www.kaggle.com/datasets/jainpooja/fake-news-detection")
st.markdown("##### \n-My Linkedin Profile: https://www.linkedin.com/in/kartik-singh-codolearn/")
st.markdown("##### \n-My Kaggle Profile: https://www.kaggle.com/kartikexe")
